            ...
            if (decimals > 0) { //use decimal formatter
                ...
                all_chart_options.tooltip.formatter = function () {
                    ...
                    $.each(this.points, function (i) {
                        ...
                        var y_val = this.point.high ? " High: " + signs_arr[0] + Highcharts.numberFormat((this.point.high * multiplier), decimals, ".", ",") + signs_arr[1] + " | Low: " + signs_arr[0] + Highcharts.numberFormat((this.point.low * multiplier), decimals, ".", ",") + signs_arr[1] :
                            signs_arr[0] + Highcharts.numberFormat((this.point.y * multiplier), decimals, ".", ",") + signs_arr[1];
                ...
                all_chart_options.tooltip.formatter = function () {
                    ...
                    $.each(this.points, function (i) {
                        ...
                        var y_val = this.point.high ? " High: " + signs_arr[0] + $(this.point.high * multiplier).addCommas() + signs_arr[1] + " | Low: " + signs_arr[0] + $(this.point.low * multiplier).addCommas() + signs_arr[1] :
                            signs_arr[0] + $(this.point.y * multiplier).addCommas() + signs_arr[1];
