...
var update_individual_series = {
    ...
    makeSeriesExtraDataDiv: function makeSeriesExtraDataDiv(all_chart_options, i, j) {
        ...
        $(series_extra_data_title_textarea).css({ "height": "30px" }).addClass("series_extra_data_title_textarea").attr("id", "series_extra_data_title_textarea").val(all_chart_options.series[i].extra_data ? all_chart_options.series[i].extra_data[j].name : "");
