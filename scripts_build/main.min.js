...
},{"./draw_chart.js":15,"./form_updates/all_form_updates.js":16,"./initializers/charts/all_chart_options_init.js":30,"./navigation_setup.js":53,"./utils/jq_extensions.js":63,"./utils/load_from_table_wizard":64,"./utils/utils_main":66}],2:[function(require,module,exports){
"use strict";
...
},{"./draw_chart.js":15,"./form_updates/all_form_updates.js":16,"./form_updates/update_individual_series.js":22,"./initializers/charts/all_chart_options_init.js":30,"./utils/utils_forms.js":65,"./utils/utils_main.js":66}],3:[function(require,module,exports){
"use strict";
...
},{"../draw_chart.js":15,"../utils/utils_main":66}],18:[function(require,module,exports){
"use strict";
...
},{"../parsers/parse_table_input.js":60,"../utils/utils_forms.js":65}],22:[function(require,module,exports){
"use strict";
...
var update_individual_series = {
    ...
    makeSeriesExtraDataDiv: function makeSeriesExtraDataDiv(all_chart_options, i) {
...
},{"../keyboard_inputs.js":52,"../utils/utils_forms.js":65,"../utils/utils_main.js":66}],23:[function(require,module,exports){
"use strict";
...
},{"../initializers/maps/map_init.js":47,"../utils/utils_main.js":66}],25:[function(require,module,exports){
"use strict";
...
},{"../initializers/maps/map_colors_init.js":45,"../initializers/maps/map_init.js":47}],26:[function(require,module,exports){
"use strict";
...
var update_tooltip = {
    ...
    getBubbleTooltip: function getBubbleTooltip(chart, decimals, signs_arr, multiplier, chart_type, z_title, all_chart_options) {
    ...
    getScatterTooltip: function getScatterTooltip(chart, decimals, signs_arr, multiplier, chart_type, all_chart_options) {

        all_chart_options.tooltip.formatter = function () {
            var y_axis_title = this.series.yAxis.axisTitle ? this.series.yAxis.axisTitle.textStr : "Y-Axis";
            var x_axis_title = this.series.xAxis.axisTitle ? this.series.xAxis.axisTitle.textStr : "X-Axis";

            var s = "<b>" + this.series.name + "</b><br>" + y_axis_title + ": <b>" + signs_arr[0] + Highcharts.numberFormat(this.y * multiplier, decimals, ".", ",") + signs_arr[1] + "</b><br>" + x_axis_title + ": <b>" + signs_arr[0] + Highcharts.numberFormat(this.x * multiplier, decimals, ".", ",") + signs_arr[1] + "</b>";
    ...
    getTypicalTooltip: function getTypicalTooltip(chart, is_shared, decimals, signs_arr, multiplier, chart_type, all_chart_options) {
        ...
        if (is_shared) {
            ...
            if (decimals > 0) {
                ...
                all_chart_options.tooltip.formatter = function () {
                    ...
                    $.each(this.series.chart.series, function (i) {
                        ...
                        var y_val = this.points[point.x].high ? " High: " + signs_arr[0] + Highcharts.numberFormat(this.points[point.x].high * multiplier, decimals, ".", ",") + signs_arr[1] + " | Low: " + signs_arr[0] + Highcharts.numberFormat(this.points[point.x].low * multiplier, decimals, ".", ",") + signs_arr[1] : signs_arr[0] + Highcharts.numberFormat(this.points[point.x].y * multiplier, decimals, ".", ",") + signs_arr[1];
                ...
                all_chart_options.tooltip.formatter = function () {
                    ...
                    $.each(this.series.chart.series, function (i) {
                        ...
                        var y_val = this.points[point.x].high ? " High: " + signs_arr[0] + $(this.points[point.x].high * multiplier).addCommas() + signs_arr[1] + " | Low: " + signs_arr[0] + $(this.points[point.x].low * multiplier).addCommas() + signs_arr[1] : signs_arr[0] + $(this.points[point.x].y * multiplier).addCommas() + signs_arr[1];
            ...
            if (decimals > 0) {
                ...
                all_chart_options.tooltip.formatter = function () {
                    ...
                    var y_val = this.point.high ? "High: " + signs_arr[0] + $(this.point.high * multiplier).addCommas() + signs_arr[1] + " | Low: " + signs_arr[0] + $(this.point.low * multiplier).addCommas() + signs_arr[1] : signs_arr[0] + $(this.y * multiplier).addCommas() + signs_arr[1];
...
},{"../utils/utils_forms":65,"../utils/utils_main.js":66}],28:[function(require,module,exports){
'use strict';
...
},{"../utils/utils_main.js":66}],30:[function(require,module,exports){
"use strict";
...
},{"../../constructors/charts/all_chart_options.js":3,"../../parsers/parse_table_input.js":60,"../../utils/utils_forms.js":65,"./chart_init.js":31,"./colors_init.js":32,"./credits_init.js":33,"./exporting_init.js":34,"./legend_init.js":35,"./plot_options_init.js":36,"./series_init.js":37,"./subtitle_init.js":38,"./title_init.js":39,"./tooltip_init.js":40,"./x_axis_init.js":41,"./y_axis_init.js":42}],31:[function(require,module,exports){
"use strict";
...
},{"../../constructors/charts/plot_options.js":8,"../../form_updates/update_legend.js":23,"../../utils/utils_forms.js":65}],37:[function(require,module,exports){
"use strict";
...
},{"../../constructors/charts/tooltip.js":12,"../../utils/utils_forms.js":65}],41:[function(require,module,exports){
"use strict";
...
},{"../../constructors/charts/x_axis.js":13,"../../form_updates/update_x_axis.js":28,"../../utils/utils_forms.js":65}],42:[function(require,module,exports){
"use strict";
...
},{"../../constructors/charts/y_axis.js":14,"../../form_updates/update_y_axis.js":29,"../../utils/utils_forms.js":65,"../../utils/utils_main.js":66}],43:[function(require,module,exports){
"use strict";
...
},{"../../utils/utils_main.js":66}],45:[function(require,module,exports){
"use strict";
...
},{"../../form_updates/all_form_updates.js":16,"../../utils/utils_forms.js":65,"../../utils/utils_main.js":66}],46:[function(require,module,exports){
"use strict";
...
},{"../../form_updates/update_map_individual_series.js":24,"../../form_updates/update_template.js":26,"../../navigation_setup.js":53,"../../parsers/parse_for_map.js":56,"../../utils/areas_colored_report.js":61,"../../utils/utils_forms.js":65,"./map_animation_init.js":43,"./map_circle_sizes_init.js":44,"./map_colors_init.js":45,"./map_credits_init.js":46,"./map_legend_init":48,"./map_subtitle_init.js":49,"./map_title_init.js":50,"./map_tooltip_init.js":51}],48:[function(require,module,exports){
"use strict";
...
},{"./form_updates/update_individual_series.js":22}],53:[function(require,module,exports){
"use strict";
...
},{"./form_updates/update_individual_series.js":22,"./keyboard_inputs.js":52,"./utils/utils_main.js":66,"./utils/write_code.js":67}],54:[function(require,module,exports){
"use strict";
...
},{"./parse_for_bubble.js":54,"./parse_for_drilldown.js":55,"./parse_for_range.js":57,"./parse_for_scatter.js":58,"./parse_for_typical_chart.js":59}],61:[function(require,module,exports){
"use strict";
...
},{"../utils/utils_main.js":66}],63:[function(require,module,exports){
"use strict";
...
},{"../form_updates/update_tooltip.js":27,"../form_updates/update_y_axis.js":29}],67:[function(require,module,exports){
"use strict";
...
},{"../chart_recall.js":2,"../draw_chart.js":15,"../initializers/maps/map_animation_init.js":43,"../initializers/maps/map_credits_init.js":46,"../initializers/maps/map_init.js":47,"../initializers/maps/map_legend_init.js":48,"../initializers/maps/map_subtitle_init.js":49,"../initializers/maps/map_title_init.js":50,"../initializers/maps/map_tooltip_init.js":51,"./utils_main.js":66}]},{},[1])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
