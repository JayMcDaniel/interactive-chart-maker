...
var map_colors_init = {
    ...
    newColorArray: function newColorArray(color_palette, all_map_options) {
        ...
        } else if ($(".map_color_div .jscolor").length > 0) {
                //grab from custom if available
